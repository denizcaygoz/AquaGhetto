...
repositories {
    ...
    maven {
        url = uri("https://sopra-gitlab.cs.tu-dortmund.de/api/v4/projects/1707/packages/maven")
        credentials(HttpHeaderCredentials::class) {
            name = "Private-Token"
            value = "glpat-yGTJby4s2sB6gYsGvsDd"
        }
        authentication {
...
dependencies {
    ...
    implementation(group = "tools.aqua", name = "bgw-net-common", version = "0.9-4-06a99c3-SNAPSHOT")
    implementation(group = "tools.aqua", name = "bgw-net-client", version = "0.9-4-06a99c3-SNAPSHOT")
...
tasks.jacocoTestReport {
    ...
    classDirectories.setFrom(files(classDirectories.files.map {
        fileTree(it) {
            exclude(listOf("view/**", "entity/**",  "Main*.*", "service/aiServices/**"))
        }
    }))
}
